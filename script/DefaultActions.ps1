...
#     Param($actor)
#     Invoke-TTAction "Table.Nth.Invoke" $actor
...
#     [TTExModMode]::FdPanel().UpdateSections('openall')
#     return $true
# }
# Add-TTAction    Memo.View.CloseAllSections              '表示：全て閉じる' {
#     [TTExModMode]::FdPanel().UpdateSections('closeall')
#     return $true
# }
# Add-TTAction    Memo.View.OpenSection                   '表示：セクション開く' {
#     [TTExModMode]::FdPanel().UpdateSections('open+')
#     return $true
# }
# Add-TTAction    Memo.View.CloseSection                  '表示：セクション閉じる' {
#     [TTExModMode]::FdPanel().UpdateSections('close+')
#     return $true
# }
# write-host "251110: キーワードが表示された行のみ開く"
# Add-TTAction    Memo.View.OpenKeywordSections           '表示：キーワード行を開く' {
#     [TTExModMode]::FdPanel().UpdateSections('openallkeyword')
#     return $true
# }
# write-host "251110: キーワードが表示された行のみ閉じる"
# Add-TTAction    Memo.View.ShowKeywordSections          '表示：キーワード行を閉じる' {
#     [TTExModMode]::FdPanel().UpdateSections('showallkeyword')
#     return $true
# }
# #endregion
# #region 特定編集
...
#     return $true
# }
# write-host '251006:Add-TTWebScriptとかを作って定義するのは？'
